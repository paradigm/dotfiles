...
command! -nargs=+ -complete=customlist,parainclude#d_comp Dsearch :call parainclude#dsearch(<q-args>, 1)
command! -nargs=+ -complete=customlist,parainclude#d_comp Dlist   :call parainclude#dlist(<q-args>)
command! -nargs=+ -complete=customlist,parainclude#d_comp Djump   :call parainclude#djump(<q-args>, 1)
command! -nargs=+ -complete=customlist,parainclude#d_comp Dqf     :call parainclude#dqf(<q-args>) | call cconerror#qf()
command! -nargs=+ -complete=customlist,parainclude#d_comp Dloc    :call parainclude#dloc(<q-args>) | call cconerror#loc()
